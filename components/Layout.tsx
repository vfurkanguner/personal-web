  ...
  return (
    <div className="">
      ...
      <meta http-equiv="Content-Security-Policy" content="default-src https://vitals.vercel-insights.com; child-src 'none'; object-src 'none'" />
        ...
        <meta name="description" content="V. Furkan Güner" />
      ...
      <aside className="lg:flex flex-col justify-center items-center  gap-y-4 absolute z-10  bottom-0 hidden left-[2%] ">
        <a target="_blank" rel="noreferrer" className="hover:cursor-pointer group hover:-translate-y-1 hover:scale-110" href="https://twitter.com/vfurkanguner">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
        ...
        <a target="_blank" rel="noreferrer" className="hover:cursor-pointer group hover:-translate-y-1 hover:scale-110" href="https://instagram.com/vfurkanguner">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-indigo-500"
        ...
        <a target="_blank" rel="noreferrer" className="hover:cursor-pointer group hover:-translate-y-1 hover:scale-110" href="https://github.com/vfurkanguner">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-indigo-500"
        ...
        <a target="_blank" rel="noreferrer" className="hover:cursor-pointer group hover:-translate-y-1 hover:scale-110" href="https://www.linkedin.com/in/furkan-g%C3%BCner-5615a410a/">
          <svg
            viewBox="0 0 24 24"
            className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-indigo-500"
          >
