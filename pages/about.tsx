      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12 text-zinc-800 dark:text-zinc-200">
        ...
        <div className="lg:pl-20">
          <div className="max-w-xs px-2.5 lg:max-w-none">
            <img
              ...
              decoding="async"
              data-nimg="future"
              className="aspect-square grayscale hover:grayscale-0 rotate-3 rounded-2xl bg-zinc-100 object-cover dark:bg-zinc-800"
              loading="lazy"
            />
          </div>
        </div>
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            ...
            {'  '}
            <span className="bg-gradient-to-r dark:via-indigo-600 via-indigo-600 bg-clip-text from-yellow-500 to-blue-600 dark:from-yellow-600 dark:to-blue-600 text-transparent">
               digital products.
            </span>
          </h1>
        ...
        {/* Icons */}
        <div className="lg:pl-20">
          <ul role="list" className="grid space-y-4">
            <li className="group inline-flex hover:cursor-pointer">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
              ...
              <a
                rel="noreferrer"
                href="https://twitter.com/vfurkanguner"
                target="_blank"
              >
            ...
            <li className="group inline-flex hover:cursor-pointer">
              ...
              <a
                href="https://instagram.com/vfurkanguner"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li className="group inline-flex hover:cursor-pointer">
              ...
              <a
                href="https://github.com/vfurkanguner"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li className="group inline-flex pb-2 hover:cursor-pointer">
              <svg
                viewBox="0 0 24 24"
                className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-indigo-500"
              >
              ...
              <a
                href="https://www.linkedin.com/in/furkan-g%C3%BCner-5615a410a/"
                rel="noreferrer"
                target="_blank"
              >
            ...
            <li className="inline-flex hover:cursor-pointer  border-t border-zinc-100 pt-8 dark:border-zinc-700/40">
              <svg
                viewBox="0 0 24 24"
                aria-hidden="true"
                className="h-6 w-6 flex-none fill-zinc-500 transition group-hover:fill-indigo-500"
              ...
              <span className="ml-2">vfurkanguner@gmail.com</span>
            </li>
          </ul>
        </div>
      </div>
